...
public class MULD extends Instruction {
	...
	private int fpMultiplierIndex;

	public MULD(Opcode code, int exeCycles, String label, 
			    FPRegister dest, FPRegister src1, FPRegister src2) {
		super(Opcode.MULD, exeCycles, label);
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
	}

	public MULD(FPRegister dest, FPRegister src1, FPRegister src2) {
		super(Opcode.MULD, 30, "");
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
	}
	...
	public int getFpMultiplierIndex() {
		return fpMultiplierIndex;
	}
	
	public void setFpMultiplierIndex(int index) {
		fpMultiplierIndex = index;
	}
	...
	public void releaseResource() {
		...
		Src1.setIdle();
		Src2.setIdle();
		FuncUnitController.getInstance().getFPMultiplier(fpMultiplierIndex).setAvailable();

...
public class ADDD extends Instruction {
	...
	public ADDD(Opcode code, int exeCycles, String label, FPRegister dest,
			FPRegister src1, FPRegister src2) {
		super(Opcode.ADDD, exeCycles, label);
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
	}

	public ADDD(FPRegister dest, FPRegister src1, FPRegister src2) {
		super(Opcode.ADDD, 2, "");
		Destination = dest;
		Src1 = src1;
		Src2 = src2;

...
public class OR extends Instruction {
	...
	public OR(Opcode code, int exeCycles, String label, 
			    IntegerRegister dest, IntegerRegister src1, IntegerRegister src2) {
		super(Opcode.OR, exeCycles, label);
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
	}
	
	public OR(IntegerRegister dest, IntegerRegister src1, IntegerRegister src2) {
		super(Opcode.OR, 1, "");
		Destination = dest;
		Src1 = src1;
		Src2 = src2;

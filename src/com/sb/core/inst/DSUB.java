...
public class DSUB extends Instruction {
	...
	public DSUB(Opcode code, int exeCycles, String label, 
			    IntegerRegister dest, IntegerRegister src1, IntegerRegister src2) {
		super(Opcode.DSUB, exeCycles, label);
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
	}

	public DSUB(IntegerRegister dest, IntegerRegister src1, IntegerRegister src2) {
		super(Opcode.DSUB, 1, "");
		Destination = dest;
		Src1 = src1;
		Src2 = src2;
